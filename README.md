About mapkit-feedstock
======================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/mapkit-feedstock/blob/main/LICENSE.txt)
...
Development: https://github.com/CI-WATER/mapkit
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=4841&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/mapkit-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `mapkit` can be installed with `conda`:
...
```
mamba install mapkit
```

It is possible to list all of the versions of `mapkit` available on your platform with `conda`:
...
```
mamba search mapkit --channel conda-forge
```
...
mamba repoquery search mapkit --channel conda-forge

# List packages depending on `mapkit`:
mamba repoquery whoneeds mapkit --channel conda-forge

# List dependencies of `mapkit`:
mamba repoquery depends mapkit --channel conda-forge
```
